    ...
    <div class="welcome-banner welcome-normal section-container container">
          <div class="row">
            <div class="col-xs-12 text-center">
                  <h1 class="h1-normal">Student Council Election 2020</h1>
                  <p class="p-normal">
                  Cast Your Vote
                  </p>
            </div>
                ...
                <div class="row form-group">
                      <div class="col-xs-12">
                          <ul class="nav nav-pills nav-justified setup-panel">
                            ...
                            <h6 class="list-group-item-heading">Secritary</h6>
                            </a></li>
                            ...
                            <li class="disabled"><a href="#step-9">
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio1"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio2"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio3"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                            <button id="activate-step-2" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio4"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio5"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio6"><b>Vote</b></label>
                                </div>
                                </div>
                              </div>
                            <button id="activate-step-3" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio7"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio8"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio9"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-4" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio10"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio11"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio12"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-5" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio13"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio14"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio15"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-6" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio16"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio17" />
                                    <label for="radio17"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio18" />
                                    <label for="radio18"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-7" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio19" />
                                    <label for="radio19"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio20" />
                                    <label for="radio20"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio21"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-8" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row voteradio">
                              <div class="col-sm-12 col-md-4 text-center">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    ...
                                    <label for="radio22"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio23" />
                                    <label for="radio23"><b>Vote</b></label>
                                </div>
                              </div>
                              <div class="col-sm-12 col-md-4 text-center">
                                <div class="candidate-avatar">
                                ...
                                <div class="voteradio-success col-md-6 col-md-offset-3">
                                    <input type="radio" name="radio" id="radio24" />
                                    <label for="radio24"><b>Vote</b></label>
                                </div>
                              </div>
                            <button id="activate-step-9" class="btn btn-primary btn-xl pull-right">Next</button>
                          </div>
                        </div>
                    </div>
                </div>
